...
POINT_FOLLOWING_PINK=1611,793,${AFF_TOP}
RGB_DEC_FOLLOWING_PINK=252,89,134

POINT_FOLLOWING_WHITE=1622,803,${AFF_TOP}
RGB_DEC_FOLLOWING_WHITE=255,255,255

POINT_FOLLOWER_BLUE=1678,793,${AFF_TOP}
RGB_DEC_FOLLOWER_BLUE=40,154,233

POINT_FOLLOWER_WHITE=1692,803,${AFF_TOP}
...
POINT_RESTART_BUTTON_LOWER_PINK=1740,1056,${AFF_BOTTOM}
RGB_DEC_RESTART_BUTTON_LOWER_PINK=255,79,151

POINT_RESTART_BUTTON_LEFT_YELLOW=1634,1026,${AFF_BOTTOM}
RGB_DEC_RESTART_BUTTON_LEFT_YELLOW=252,233,138

POINT_RESTART_BUTTON_RIGHT_YELLOW=1849,1026,${AFF_BOTTOM}
RGB_DEC_RESTART_BUTTON_RIGHT_YELLOW=253,234,141
...
test_point()
{
  ...
  echo "test_point"
  echo "${POS_X_Y_NAME}";
  POS_X_Y=$(eval "echo \${${POS_X_Y_NAME}}" | tr ',' ' ')
